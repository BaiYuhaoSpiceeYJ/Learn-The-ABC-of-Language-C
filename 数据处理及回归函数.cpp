...
double flin(int n,double avgx,double avgy,double x[],double y[])//回归方程函数
{
	int i;
...
int main()
{
	...
	printf("x的平方的和为：%.2lf\n",sumx2);
	printf("y的平方的和为：%.2lf\n",sumy2);
	printf("x的平方的平均值为：%.2lf\n",avgx2);
	printf("y的平方的平均值为：%.2lf\n",avgy2);
	printf("x*y的和为：%.2lf\n",sumxy);
	printf("x*y的平均值为：%.2lf\n",avgxy);
	printf("x的总体方差为：%.2lf\n",d2x);
	printf("y的总体方差为：%.2lf\n",d2y);
	...
	printf("y的变异系数为：%.2lf\n",vy);
	printf("x、y的协方差为：%.2lf\n",covxy);
	printf("x、y的线性相关系数为：%.2lf\n",r);
	printf("x、y的回归方程为：y=%.2lfx+%.2lf\n",b,a); 
